...
#upload_product ${BITS}/PKS/pivotal-container-service-1.6.0-build.17.pivotal
...
upload_stemcell ${BITS}/PKS/bosh-stemcell-456.51-vsphere-esxi-ubuntu-xenial-go_agent.tgz
